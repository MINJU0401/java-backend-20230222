...
//	NUMBER2 = 12;   <  상수(final)로 선언해서 값변경이 안됨 
	}

//class Example2_1 extends Example2 {
//	void function2() {}  > function2  메서드가 final로 선언되어 오버라이드 불가
//}  
...
//	클래스 선언문에 abstract가 포함되어 있으면 해당 클래스는 구현되지 않은 메서드를 포함하고 있음을 의미함
abstract class Example3 {
	//	메서드 선언문에 abstract가 포함되어 있으면 해당 메서드는 구현되지 않았음을 의미
	abstract void function3();   // 구현부 작성없이 ; 으로 마무리 (구현부 작성하면 error)	
}
