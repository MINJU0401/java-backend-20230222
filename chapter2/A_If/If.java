...
//	if 구문
//	조건에 따라 실행시키고자하는 로직(프로세스)이 다를 때 사용하는 구문
...
public class If {
	...
	public static void main(String[] args) {
		...
		//	if문과 마찬가지로 else문도 코드 블럭에 오는 실행할 코드가 하나의 구문이면 중괄호{}를 제거하고 사용 가능
		if (age > 19) System.out.println("성인입니다.");
		...
		//	중첩 if문은 쓰지않는 것을 권장(어쩔수없는 경우 제외)
		
		System.out.println("-----else if문-----");
		//	if - else if - else 문
		//	중첩 if문의 응용
		//	else문의 코드 블럭에 오는 코드가 한 줄일 때 {}을 제거할 수 있음을 이용
		if (age > 19) {
			System.out.println("성인입니다.");
		} else if (age < 8) {
